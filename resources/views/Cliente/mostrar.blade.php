                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <h5 class="card-title">{{$cliente['apellidos']}}</h5>
                                           <p class="card-text"><small class="text-muted">{{$cliente['direccion']}}</small></p>
                                           <p class="card-text"><small class="text-muted">{{$cliente['telefono']}}</small></p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Agregar nueva Cliente</h5>
